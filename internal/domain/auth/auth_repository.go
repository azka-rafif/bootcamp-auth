...
func (r *AuthRepositoryMySQL) txCreate(tx *sqlx.Tx, payload User) (err error) {
	query := `insert into user (id,username,name,password,role,created_at,created_by,updated_at,updated_by)
    VALUES (:id,:username,:name,:password,:role,:created_at,:created_by,:updated_at,:updated_by)`
